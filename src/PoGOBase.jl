...
export Pokemon, Species
export matching_pokemon, only_pokemon, uniquename, eachpokemon
export base_stats, stats, combat_power, hp
export megaevolve, purify, baby, all_ids
export damage
export league_max_level, league_catch_cp, statproduct_league, statproducts_league, best_for_league
